...
export default function Details() {
  ...
  return (
    <div className="min-h-[100vh]" style={{ background: colors.background }}>

      <div className="fixed w-full flex justify-between items-center p-3 z-100 h-[50px] top-0 left-0"
        style={{ background: colors.background }}>
        <h3 className="text-xl font-normal" style={{ color: colors.text }}>
          Setup your Profile
        </h3>
        <span className="text-lg font-base" style={{ color: colors.accent }}>Skip</span>
      </div>
      ...
      <div className="grid gap-3 p-3 pt-[120px]">
        ...
        <div className="w-full flex items-center justify-center">
          <div className="relative w-[180px] h-[180px] rounded-[50%] bg-red-500">
            ...
            />
            <label htmlFor="file"
              className="absolute w-[45px] h-[45px] rounded-[50%] bottom-5 right-0 flex items-center justify-center"
        ...
        <div className="form grid gap-5 grid-cols-1 md:grid-cols-1 lg:grid-cols-2 w-full">

          <div className="grid gap-1">
            <span className="text-sm font-semibold uppercase" style={{ color: colors.textPrimary }}>
              occupation:
            </span>
            <input
              type="text"
              ...
              className="text-sm font-semibold border-[2px] focus:border-blue p-[12px] rounded-xl outline-none w-full"
